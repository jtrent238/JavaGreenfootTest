 ...
 * @version 1.0
 */
public class KillsCounter extends Actor
{
     ...
     */
    public KillsCounter(String prefix)
    {
    ...
    private void updateImage()
    {
        ...
        GreenfootImage text = new GreenfootImage("Kills: " + prefix + value, 22, Color.BLACK, transparent);
